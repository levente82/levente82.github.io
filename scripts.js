let data = {
    photo: ['./images/alexander-popov.jpg', './images/bridge.jpg', './images/harley-davidson.jpg', './images/james-mccullough.jpg', './images/jason-zhao.jpg', './images/manki-kim.jpg', './images/red-zeppelin.jpg', './images/vitor-pinto.jpg'],
    title: ['Stores in Russia', 'Bridge near the sea', 'Ride on an Harley Davidson motor', 'Rocks', 'Junctions', 'Indoor plants', 'Lighthouse', 'Toyota'],
    description: ['Local stores that are open at night too.', 'Bridge that connect Us.',
    'Enjoy motorcycling....', 'Rocks everywhere...', 'From here you can go anywhere.',
    'Indooor plants makes inside more like in the nature', 
    'Lighthouse which shows the right way to the sailors and ships.',   
    'A very attractive sport car.'
]
};
...
function printImage(){
    ...
    if (currentPhoto === 5) {
        thumb5.style.background = 'rgb(65 179 247)';
    } else {
        thumb5.style.background = 'inherit';
    }
    if (currentPhoto === 6) {
        thumb6.style.background = 'rgb(65 179 247)';
    } else {
        thumb6.style.background = 'inherit';
    }
    if (currentPhoto === 7) {
        thumb7.style.background = 'rgb(65 179 247)';
    } else {
